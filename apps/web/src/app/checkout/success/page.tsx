...
function CheckoutSuccessContent() {
  ...
  useEffect(() => {
    ...
    if (!isAuthenticated) {
      console.log('[REDIRECT] checkout/success/page.tsx -> /auth/login', {
        _hasHydrated,
        isAuthenticated,
      })
    ...
    <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="text-center mb-8">
        ...
        <p className="text-gray-600">
          Дякуємо за ваше замовлення. Ми відправили підтвердження на вашу
          електронну пошту.
        </p>
      </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-green-700 mt-1">
                Ваше замовлення оплачене онлайн. Ми почнемо обробку вашого
                замовлення найближчим часом.
              </p>
            </div>
          </div>
        </div>
            ...
            <div>
              ...
              <p className="text-sm text-blue-700 mt-1">
                {order.deliveryType === 'pickup'
                  ? 'Оплатіть замовлення готівкою або карткою при отриманні в магазині.'
      ...
      <div className="bg-white rounded-lg shadow p-6 mb-6">
        <div className="flex items-center gap-2 mb-4">
          <h2 className="text-xl font-semibold">Інформація про доставку</h2>
          {order.deliveryType === 'pickup' ? (
        ...
        <div className="space-y-3">
          {order.deliveryType === 'pickup' ? (
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="text-sm text-gray-600">Пункт самовивозу</p>
                <p className="font-semibold text-gray-900">
